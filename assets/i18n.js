...
(function () {
  ...
  var dict = {
    ...
    "Construindo Software Mais Forte": "Building Stronger Software",
    "Do código ao resultado!": "From code to results!",
    "Entregamos sistemas sob demanda de alta qualidade com precisão.": "We deliver high-quality on-demand systems with precision.",
    "Escale seu produto sem esforço, uma release de cada vez.": "Scale your product effortlessly, one release at a time.",
    ...
    "Recursos de Engenharia Ilimitados": "Unlimited Engineering Resources",
    "Entregue em tempo recorde!": "Delivered in record time!",
    "Tenha capacidade de desenvolvimento sob demanda para construir, escalar e evoluir seu produto sem barreiras.": "Get on-demand development capacity to build, scale and evolve your product without limits.",
    "Aumente Sua Receita": "Boost Your Revenue",
    "Escale com Dados": "Scale With Data",
    "Desbloqueie novas fontes de receita com decisões orientadas por métricas, analytics e automação inteligente.": "Unlock new revenue streams with decisions driven by metrics, analytics and smart automation.",
    "Arquitetura Flexível": "Flexible Architecture",
    "Componentes Reutilizáveis": "Reusable Components",
    "Módulos e APIs configuráveis que se adaptam à sua stack e crescem junto com o seu negócio.": "Configurable modules and APIs that adapt to your stack and grow with your business.",
    "Desenvolvimento com Menos Bugs": "Development With Fewer Bugs",
    "Código Otimizado": "Optimized Code",
    "Práticas de testes automatizados e CI/CD garantem que seu software rode de forma fluida, segura e estável.": "Automated testing and CI/CD practices ensure your software runs smoothly, securely and reliably.",
    "Soluções Premiadas": "Award-Winning Solutions",
    "Tecnologia Reconhecida": "Recognized Technology",
    "Nossas soluções de engenharia combinam inovação e confiabilidade que nos destacam no setor.": "Our engineering solutions combine innovation and reliability that set us apart in the industry.",
    "Entrega Extremamente Rápida": "Lightning-Fast Delivery",
    "Deploy Ágil": "Agile Deployment",
    "Releases contínuos e entregas previsíveis: suas funcionalidades prontas quando você precisa, sem perder qualidade.": "Continuous releases and predictable delivery: your features ready when you need them, without compromising quality.",
    "Resposta Rápida": "Fast Response",
    "Compatível com Qualquer Plataforma": "Compatible With Any Platform",
    "Multiplataforma": "Cross-Platform",
    "Aplicações responsivas e nativas que funcionam perfeitamente em web, mobile e desktop.": "Responsive and native applications that work flawlessly on web, mobile and desktop.",
    ...
    "Produto": "Product",
    "Pacote de Produto Digital": "Complete Digital Product Package",
    "Da concepção do produto à interface e à experiência do usuário, projetamos aplicações intuitivas e escaláveis, cuidando de toda a jornada do seu produto digital.": "From product conception to interface and user experience, we design intuitive, scalable applications, handling every step of your digital product journey.",
    "Prototipação + UX/UI da Aplicação": "Application Prototyping + UX/UI",
    "Componentes Prontos para Escalar": "Components Ready to Scale",
    ...
    // Valores das ofertas em USD/EUR (versão em inglês); os preços
    // riscados (originais) são ocultados ("" => <del> vazio).
    "R$997": "$987 / €907",
    "R$2.599": "$1987 / €1827",
    "R$1450": "",
    "R$3997": "",
    ...
    "Entrega, Qualidade e Tecnologia.": "Delivery, Quality and Technology.",
    ...
    "\"Suas soluções inovadoras ajudaram a otimizar nossas operações, e o desenvolvimento do sistema é robusto, rápido e confiável.\"": "\"Their innovative solutions helped streamline our operations, and the system's development is robust, fast and reliable.\"",
    "\"Ficamos impressionados com a abordagem técnica e a atenção aos detalhes. A equipe pegou nossas ideias e as transformou em um produto sólido.\"": "\"We were impressed by the technical approach and attention to detail. The team took our ideas and turned them into a solid product.\"",
    "\"A dedicação e a atenção aos detalhes da equipe são incomparáveis. Eles entregaram um produto sólido que reflete perfeitamente nosso negócio.\"": "\"The team's dedication and attention to detail are unmatched. They delivered a solid product that perfectly reflects our business.\"",
    "· Fundador": "· Founder",
